							...
							<div id="content">
								<div class="post">
									...
									<div class="entry">
										...
										<table border="4" width="100%" style="border-width: 9px;border-style: solid; border-bottom-color:1px solid black;font-family:TimesNewRoman; font-style: italic;  font-size: large;">
											...
											<?php
												...
												while($row=mysqli_fetch_assoc($res))
												{
													...
													echo '<td valign="top" width="20%" align="center">
														...
														<br> Name:   '.$row['b_nm'].'
														<br> Price:   '.$row['b_price'].'
														<br> Publisher: '.$row['b_publisher'].'</a>
													</td>';
													$count++;							
